...
dev: ## Run dev servers for all packages
	@npx concurrently -c "auto" "pnpm --filter=@m/client run dev" "pnpm --filter=@m/server run dev" "pnpm --filter=@milestone/shared run dev"
